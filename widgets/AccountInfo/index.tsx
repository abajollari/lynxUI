        ...
        <div className={style.container}>
            ...
            <div className={style.chart}>
                <PieChart
                    ...
                    labelStyle={{ fontSize: '6px', fill: '#fefcfb' }}
                    data={[
                        { title: 'Savings', value: 100, color: '#eb992d' },
                        { title: 'Available', value: 45, color: '#0dd5ff' },
                        { title: 'Interest', value: 20, color: '#23ce6b' },
                    ]}
                />
            </div>
        </div>
